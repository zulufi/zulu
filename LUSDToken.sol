...
contract LUSDToken is CheckContract, ILUSDToken, Initializable {
    ...
    string constant internal _NAME = "ZULU USD Stablecoin";
    string constant internal _SYMBOL = "zlUSD";
    ...
    function burn(address _account, uint256 _amount) external override {
        _requireCallerIsBOorROorSP();
        _burn(_account, _amount);
    }

    function sendToPool(address _sender,  address _poolAddress, uint256 _amount) external override {
        _requireCallerIsROorSP();
        _transfer(_sender, _poolAddress, _amount);
    }

    function returnFromPool(address _poolAddress, address _receiver, uint256 _amount) external override {
        _requireCallerIsLOorSP();
    ...
    function _requireValidRecipient(address _recipient) internal view {
        ...
        require(
            ...
            _recipient != liquidatorOperationsAddress &&
            _recipient != redeemerOperationsAddress,
            "LUSD: Cannot transfer tokens directly to the StabilityPool, TroveManager or BO or LO or RO"
        );
    }
    ...
    function _requireCallerIsBOorROorSP() internal view {
        require(
            ...
            "LUSD: Caller is neither BorrowerOperations nor RedeemerOperations nor StabilityPool"
        );
    }

    function _requireCallerIsROorSP() internal view {
        require(
            msg.sender == redeemerOperationsAddress ||
            msg.sender == stabilityPoolAddress,
            "LUSD: Caller is neither RedeemerOperations nor StabilityPool");
    }

    function _requireCallerIsLOorSP() internal view {
        require(
            msg.sender == liquidatorOperationsAddress || msg.sender == stabilityPoolAddress,
            "LUSD: Caller is neither LiquidatorOperations nor StabilityPool");
    }
